...
class AgeReceivableTemplate(models.AbstractModel):
    _name = 'report.sale_reports_baykee.age_receivable_temp'
    _description = 'Age Receivable Template'

    @api.model
    def _get_report_values(self, docids, data=None):
        docs = self.env['age.receivable.report'].browse(docids[0])
        date = docs.date
