...
class PartnerLedgerXlsx(models.AbstractModel):
    _name = 'report.accounting_reports_baykee.partner_ledger_xlsx'
    _inherit = 'report.report_xlsx.abstract'

    def generate_xlsx_report(self, workbook, data, main):
        sheet = workbook.add_worksheet('Partner Ledger XLSX Report')
